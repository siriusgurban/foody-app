        ...
        <div className="flex flex-col mt-5 sm:mt-0 sm:flex-row justify-center bg-white mx-8 mb-8">
            ...
            <div className="flex-1 flex flex-col gap-20 bg-white py-12 mx-auto w-full sm:w-1/2">
                ...
                <div className="flex gap-4 sm:gap-16 mx-auto w-max">
                    <button
                        className={`font-medium text-base sm:text-xl lg:text-3xl ${showLogin ? ' text-client-login-mainColor' : 'text-client-main-gray1'}`}
                        onClick={switchForm}
                    >
                        {t('Login')}
                    </button>
                    <button
                        className={`font-medium text-base sm:text-xl lg:text-3xl ${showLogin ? 'text-client-main-gray1' : 'font-medium text-client-login-mainColor'}`}
                        onClick={switchForm}
                    >
                        {t('Register')}
                    </button>
