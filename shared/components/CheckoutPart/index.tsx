...
function CheckoutPart() {
 ...
 // console.log("dispatch",dispatch)
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>): void {
    ...
    if (!userDatas.delivery_address || !userDatas.contact || userDatas.payment_method === null) {
      Toast({
  ...
  return <form
    className="sm:ml-5 sm:mr-2 sm:px-6 sm:py-6 w-full md:bg-[#F3F4F6] bg-[#FFFFFF]" onSubmit={handleSubmit}>
