      ...
      onClick={() => {
        {
          ...
          push(CLIENT.RESTAURANTS + item?.id)
        }
      }}
    >
      ...
      />
      {/* </Box> */}
      <Text className="text-center  md:text-start md:text-xl text-base font-medium md:font-bold overflow-hidden w-24 h-6 md:h-8 md:mb-1">
        {item?.name}
      </Text>
