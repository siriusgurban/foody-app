...
const MountainAreaChart: React.FC = () => (
    <div className="flex flex-col items-start bg-admin-secondary p-4 rounded-lg shadow-lg w-[500px] h-[400px]">
        <h2 className="text-xl font-semibold mb-4 text-admin-text font-medium">Total Salary</h2>
        <div className="w-full h-full">
            <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                    ...
                    <Area type="monotone" dataKey="year 2022" stroke={COLORS[0]} fill="url(#color2022)" />
                    <Area type="monotone" dataKey="year 2023" stroke={COLORS[1]} fill="url(#color2023)" />
                    <Area type="monotone" dataKey="year 2024" stroke={COLORS[2]} fill="url(#color2024)" />
                </AreaChart>
            </ResponsiveContainer>
        </div>
    </div>
